...
<script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=false&libraries=places&language=en-GB"></script>
<script>
$(function(){
    ...
    if (geocoder)
    {
      geocoder.geocode( { 'address': address1}, function(results, status)
      {
        if (status == google.maps.GeocoderStatus.OK)
        {
          ...
          var mapdiv = $('#map');
          mapdiv.html('<img src="https://maps.googleapis.com/maps/api/staticmap?center=' + basiclatlng + '&zoom=15&size=400x400&markers=color:blue|' + basiclatlng + '" alt="" />');
